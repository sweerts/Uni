...
\corr{Nach Eisenstein folgt zunächst nur Irreduzibilität in $\mathbb{Z}$ Es muss dafür noch überprüft werden, ob das Polynom in $\mathbb{Z}$ liegt und primitiv ist. $-0,5$ P}\\
